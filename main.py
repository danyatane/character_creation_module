...
def attack(char_name: str, char_class: str) -> str:
    """Вычисление нанесенного урона противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисление блокированного урона от противника."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применение специального умения и вычисление его силы."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Вывод информации о персонаже и тренировка его способностей."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор персонажа и вывод информации о нем."""
